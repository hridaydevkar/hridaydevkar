...
<p align="center">
<samp>
backend engineer &nbsp;·&nbsp; open source &nbsp;·&nbsp; open to SDE &amp; backend roles &nbsp;·&nbsp; graduating 2027
</samp>
</p>
...
<p align="center">
  <samp>
    <b>→ currently</b><br/><br/>
    B.Tech IT @ <b>Ramrao Adik Institute of Technology</b> &nbsp;·&nbsp; graduating 2027<br/>
    building in public &nbsp;·&nbsp; open to backend &amp; cloud engineering roles<br/>
    previously: backend intern @ <b>Route Mobile Ltd</b> &nbsp;·&nbsp; REST APIs · PostgreSQL · AWS
  </samp>
</p>
...
|:--|:--|:--|
| [**flint**](https://github.com/hridaydevkar/flint) | JavaScript · WebAssembly | from-scratch compiler — lexer → parser → type checker → IR → optimizer → hand-encoded wasm binary. zero dependencies. [try it live ↗](https://flint-weld.vercel.app/playground/) |
| [**pulsewatch**](https://github.com/hridaydevkar/pulsewatch) | Python · FastAPI · SQLite · APScheduler | self-hosted uptime monitoring & incident management — health checks, failure detection, auto-resolution, Discord/Slack/email alerts |
...
| [**fraud detection**](https://github.com/hridaydevkar/CreditCardFraudDetection) | Python · Scikit-learn · pandas | ML models (Random Forest, LightGBM) on 284K-transaction imbalanced dataset — Streamlit dashboard for real-time anomaly visualization |
...
![FastAPI](https://img.shields.io/badge/FastAPI-24292f?style=for-the-badge&logo=fastapi&logoColor=009688)
